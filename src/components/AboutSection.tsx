        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              {/* Exact text from base2roof.ae — grammar corrected */}
              ...
              {/* Company profile download — from base2roof.ae */}
              <div className="flex flex-wrap gap-3 mt-8">
                <a
                  href="https://base2roof.ae/img/base2roof_profile.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-5 py-3 rounded-xl text-sm font-semibold transition-all duration-300 shadow-red-soft hover:shadow-red-glow"
                >
                ...
                {['Dubai Municipality Licensed', 'UAE Nationwide'].map((tag) => (
                  <span key={tag} className="inline-flex items-center gap-2 bg-red-50 border border-red-100 text-red-700 px-4 py-3 rounded-xl text-xs font-semibold">
